            ...
            <div class="table-responsive">
                <table class="table cart">
                    ...
                    <tr>
                        ...
                        <th class="cart-product-subtotal uppercase">Total</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="cart_item">
                        ...
                        <td class="cart-product-thumbnail">
                            <a href="<?= site_url('product'); ?>"><img width="64" height="64" src="http://placehold.it/413x648" alt="Nombre del producto"></a>
                        </td>

                        <td class="cart-product-name">
                            <a href="<?= site_url('product'); ?>">Nombre del producto</a>
                        </td>
                        ...
                        <td colspan="6">
                            <div class="row clearfix">
                                <div class="col-md-12 col-xs-12 nopadding">
                                    <a href="<?= site_url('checkout'); ?>" class="button button-purple fright"><i class="icon-credit"></i> Checkout</a>
                                    <a href="#" class="button button-purple fright"><i class="icon-refresh"></i> Update Cart</a>
                                </div>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-6 clearfix">
                    ...
                    <form>
                        ...
                        <a href="#" class="button nomargin button-purple"><i class="icon-refresh"></i> Update Totals</a>
                    </form>
                </div>
